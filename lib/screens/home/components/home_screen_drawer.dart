    ...
    return Drawer(
      child: ListView(
        ...
        children: [
         ...
         FirebaseAuth.instance.currentUser.email == "waqassharif0302@gmail.com"  ||  FirebaseAuth.instance.currentUser.email == "roafjunaid09@gmail.com" ||  FirebaseAuth.instance.currentUser.email == "arhamsarwar786@gmail.com" || FirebaseAuth.instance.currentUser.email == "muzammil.iqbal179@gmail.com" ?
